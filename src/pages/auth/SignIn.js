...
const SignIn = () => {
  return (
    <>
      <div className="flex w-[85%] bg-white rounded-lg">
        {/* first div  */}
        <div className="flex flex-col gap-6 w-[65%] p-16">
          ...
          <form className="flex flex-col gap-6">
            ...
            <div>
              <label htmlFor="password" className="text-lg font-semibold pb-2">
                Password
              </label>
              <input
                type="password"
            ...
            <div className="grid">
              <button
                type="submit"
                className="bg-blue-500 font-semibold text-white text-2xl rounded-lg py-2 "
              >
                Sign in
              </button>
            </div>
        ...
        <div className="flex items-center justify-center bg-orange-100 w-[35%] p-16">
          <div className="flex flex-col gap-6 w-[80%]">
            <h2 className="text-start">Continue wih,</h2>
            <div className="flex items-center bg-white h-12 rounded-l-full">
            ...
            <div className="flex items-center bg-white h-12 rounded-l-full">
              ...
              <div className="flex items-center justify-center pl-14">
                <span className="text-xl font-semibold">Apple ID</span>
              </div>
            </div>
          </div>
        </div>
